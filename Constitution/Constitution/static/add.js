...
$(document).ready(function(){
    ...
    $( "#submit" ).submit(function( event ) {
        ...
        let Submitted_Author = []
        let Submitted_Utility = []
        let Submitted_Judgements = []
        let Submitted_Genres = []
            ...
            (Submitted_Genres.length==0) )
        {
            ...
            let ID_new = rights.length+1
            console.log("Here is my ID_new, " + ID_new)
            let submitted =  {
                "id": ID_new,
                "title": Submitted_title,
                "image": Submitted_image_url,
                "drafted": Submitted_year,
                "article": Submitted_article,
                "summary": Submitted_summary,
                "Author": Submitted_Author,
                "sc_interpretation": Submitted_sc_interpretation,
